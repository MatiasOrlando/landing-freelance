...
const Banner = () => {
  return (
    <div className="bg-[url(/assets/mainpic.jpg)] bg-cover bg-no-repeat xl:h-[560px] lg:h-[480px] sm:h-[360px]  xs:h-[290px]  w-auto flex flex-col items-center justify-center font-roboto pt-20 lg:pt-0 gap-8">
      <div className="flex flex-col items-center gap-4 lg:gap-0 sm:w-[500px] pb-8">
