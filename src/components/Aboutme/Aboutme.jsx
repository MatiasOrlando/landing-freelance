...
const Aboutme = () => {
  return (
    <div className="xl:flex xl:flex-row lg:flex-row md:flex-row sm:flex-row xs:flex flex-col-reverse lg:mt-[0px] md:mt-[0px] sm:mt-[0px] xs:mt-[60px] lg:w-full md:w-full sm:w-full xl:lg:h-[600px] lg:h-[500px] md:h-[400px] sm:h-[350px]  bg-gray">
      <div className=" px-4 flex items-center sm:items-start justify-center sm: justify-left  lg:w-1/2 md:w-1/2 sm:w-1/2 xs:w-full lg:h-[300px] md:h-[300px] sm:h-[350px] xs:h-[300px] ">
